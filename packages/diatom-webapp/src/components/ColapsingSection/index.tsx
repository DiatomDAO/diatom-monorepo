  ...
  return (
    <div className={classes.colapsingSectionContainer}>
      ...
      >
        ...
        <div className={classes.contentContainer}>
          <p>
            The Diatom Auction Contract will auction one Whalez NFT linearly decaying auction slots
            over the period of 2 weeks, beginning with 14 hours and diminishing until all 50 are
            won. The auctions will end on or around December 14th{' '}
            <strong>
              (not considering time spent waiting for a settler or the accumulation of 5 minute
              timer resets if bids are placed in the last 5 minutes of an auction)
            </strong>
            . 100% of auction proceeds (ETH) are automatically deposited in the DiatomDAO treasury,
            where 65% will be immediately used to fund plastic removal projects and mint the first
            PRCs. The remaining 35% will remain in the treasury for the DAO to decide how to
            allocate.
          </p>
          <p>
      ...
      >
        ...
        <div className={classes.contentContainer}>
          <p>
            ...
            (see our Medium article for more), and are an invitation for crypto Whales to prove
            crypto's true capacity for social impact (Whalez4Whales).
          </p>
          <p style={{ marginBottom: '6px' }}>
            Whalez NFT's have several unique characteristics:
          </p>
          ...
          <p>
          The name and phrase is connected to the Whalez personality and unique lore.
          </p>
        </div>
      </div>
    </div>
